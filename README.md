...
- **[torque](https://github.com/hexa3/torque)** — a real-time robotics control language with physical units as types, deadline-declared control loops, built-in pub/sub, and LLM tool-schema export
